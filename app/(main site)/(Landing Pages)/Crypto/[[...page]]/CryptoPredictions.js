...
export default function CryptoPredictions({ fetchprediction, fetchCryptoPriceData }) {
  ...
  const [oneButtonColor, setOneButtonColor] = useState('bg-white')
  const [tenButtonColor, setTenButtonColor] = useState('bg-white')
  ...
  async function fetch10PredictionMiddleWare() {
    //set button color
    setOneButtonColor('bg-white')
    setTenButtonColor('bg-lime-400')
  ...
  async function fetch1PredictionMiddleWare() {
    //set button color
    setTenButtonColor('bg-white')
    setOneButtonColor('bg-lime-400')
  ...
  return (
    <div className=' text-white '>
      ...
      <div className='flex items-center justify-center gap-5 mb-3 flex-wrap'>
        <button className={`btn ${oneButtonColor}`} onClick={fetch1PredictionMiddleWare}>One Day ForeCast</button>
        <button className={`btn ${tenButtonColor}`} onClick={fetch10PredictionMiddleWare}>Ten Day ForeCast</button>
      </div>
