...
export default function BlogRenderDeployedBlogs() {
            ...
            <div className="">
                ...
                <div className="flex justify-center items-center gap-5 md:gap-12">
                    ...
                    <div
                        ...
                        {downloadedBlogs && typeof downloadedBlogs != "string" && downloadedBlogs.filter((blog: Blog) => blog.Deployed === true).map((blog: Blog) => (
