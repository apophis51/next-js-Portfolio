...
export default function BlogRenderUncategorizedBlogs() {
    ...
    return (
        <MainContentTemplate title={"My Programming Blogs"}>
            ...
            <div className="">
                ...
                <div className="flex justify-center items-center gap-5 md:gap-12">
                    ...
                    <div
                        ...
                        {downloadedBlogs && typeof downloadedBlogs != "string" && downloadedBlogs.filter((blog: Blog) => blog.BlogType != "Programming" && blog.BlogType != "Construction").map((blog: Blog) => (
